...
@section('body')
    ...
    <div class="annual-leave-form">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Form Annual Leave</h2>
            </div>
        </div>
                    ...
                    <div class="panel-body">
                        <form action="{{ route('outsource/leave/outsource/store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1">
                                    <label for="entitlement">Balance</label>
                                    <input type="text" name="entitlement" id="entitlement" class="form-control"
                                        readonly value="{{ isset($finalBalance) ? $finalBalance : 0 }}" required>
                                </div>
                                <div class="col-lg-1">
            ...
            function calculateDays() {
                ...
                if (startDate && endDate) {
                    ...
                    if (end >= start) {
                        ...
                        var remaining = balance - daysDiff;
