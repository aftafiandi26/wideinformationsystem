...
@section('title')
    (hr) Index Summary of Leave - Detail {{ $leaveCategory->leave_category_name }}
                ...
                <tbody>
                    @foreach ($data as $key => $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('detail/edit/employee/leave/detail/summary', $value->id) }}"
                                    class="btn btn-xs btn-warning" title="edit leave date {{ $value->leave_date }}"><i
