...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-sm btn-default" id="progress" href="{{ route('leave/reschedule/index') }}">Progress &
                Reschedule</a>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form class="form-inline" method="get" action="{{ route('hrd/summary/leave/index/view/detail') }}">
                    ...
                    <button type="submit" class="btn btn-sm btn-default" title="find"><span
    ...
    <div class="modal fade" id="showModalDelete" tabindex="-1" role="dialog" aria-labelledby="showModalLabelDelete"
        aria-hidden="true">
