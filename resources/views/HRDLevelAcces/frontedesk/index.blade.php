...
<div class="col-lg-2 pull-right">
    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search items.." title="Type in a name item" class="form-control">
</div>
</div>
<div class="row">
<div class="col-lg-12" style="margin-left: 0px; overflow-x: scroll; overflow-y: scroll; height: 600px; margin-top: 10px;">
     <table width="100%" id="myTable" class="table table-hover table-condensed table-bordered">
        <thead>
            <tr>
